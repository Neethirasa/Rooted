...
export default function ArtisanPaperGoodsArticle() {
  return (
    <>
      <ArticleJsonLd
        title="What Are Artisan Paper Goods? The Rooted Canada Story"
        description="Artisan paper goods are handcrafted stationery with soul. Discover how Rooted Canada's eco-friendly seed paper cards support artisan communities and Canadian values."
        url="https://www.rootedcanada.com/blog/what-are-artisan-paper-goods"
