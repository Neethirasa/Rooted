...
export default function PhotoCardsClient() {
              ...
              >
                <div className={styles.cardInner}>
                  <div className={styles.cardFront}>
                    <Image
                      src={card.src}
                      alt={`Eco-friendly photo card ${index + 1} — Rooted Canada plantable seed paper`}
                      width={400}
                      height={500}
                    />
                  </div>
                  <div className={styles.cardBack}>
                    <span className={styles.cardBackTitle}>Photo Card</span>
                    <p>Cost: {card.cost}</p>
