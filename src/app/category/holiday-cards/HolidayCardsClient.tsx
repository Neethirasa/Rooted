...
const cardDetails: CardDetail[] = [
  { src: "/images/h1.png", cost: "$2.50", sizes: ["5x7", "A6"] },
  { src: "/images/h2.png", cost: "$2.50", sizes: ["5x7", "A6"] },
  { src: "/images/h3.png", cost: "$2.50", sizes: ["5x7", "A6"] },
  { src: "/images/h4.png", cost: "$2.50", sizes: ["5x7", "A6"] },
  { src: "/images/h5.png", cost: "$2.50", sizes: ["5x7", "A6"] },
  { src: "/images/h6.png", cost: "$2.50", sizes: ["5x7", "A6"] },
];

export default function HolidayCardsClient() {
              ...
              >
                <div className={styles.cardInner}>
                  <div className={styles.cardFront}>
                    <Image
                      src={card.src}
                      alt={`Eco-friendly holiday card ${index + 1} — seed paper seasonal greeting from Rooted Canada`}
                      width={400}
                      height={500}
                    />
                  </div>
                  <div className={styles.cardBack}>
                    <span className={styles.cardBackTitle}>Holiday Card</span>
                    <p>Cost: {card.cost}</p>
                    <p>Sizes: {card.sizes.join(", ")}</p>
                    <span className={styles.cardBackHint}>Click to flip back</span>
                  </div>
                </div>
              </div>
            ))}
