        ...
        <div className={styles.glassCard}>
          ...
          <div className={styles.textContent}>
            <section className={styles.textSection}>
              <h1 className={styles.title}>Planting With Purpose</h1>
              <p>
                We create eco-friendly Seed Paper products that bring
                sustainability and meaning to every occasion. From holiday cards to
                wedding invitations, our items are designed to grow into wildflowers
                when planted, leaving a lasting, positive impact on the environment.
              </p>
            </section>
